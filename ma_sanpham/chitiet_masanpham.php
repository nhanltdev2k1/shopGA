                            ...
                            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                                <div class="product-image">
                                    <div class="product_img_box">
                                        <img id="product_img" src='<?php echo $link_hinh; ?>' data-zoom-image="<?php echo $link_hinh; ?>" alt="product_img1" />
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="pr_detail">
                                    <div class="product_description">
                                        <p class="product_title b-p-t"><?php echo $tieude; ?></p>
                                    ...
                                    <ul class="product-meta">
                                        <li>SKU: <a href="#"><?php echo $thuocloai; ?></a></li>
