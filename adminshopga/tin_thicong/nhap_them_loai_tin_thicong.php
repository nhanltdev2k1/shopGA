...
function upload($thuocloai)
 {
    //$ketnoi_maychu = ketnoi_MC();
	//chon_CSDL($ketnoi_maychu);
	require('db.php');
   $truyvan = " INSERT INTO `loai_tin_thicong` (`thuocloai`) VALUES ('$thuocloai')";
  
   $ketqua_truyvan = mysqli_query($link,$truyvan);
   if($ketqua_truyvan){
      echo "Upload  thành công thông tin";
	  echo '<script>window.location="quan_tri.php?p=danhsach_loai_tinthicong"</script>';
   }else{
