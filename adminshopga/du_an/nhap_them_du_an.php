  ...
  <table width="780" height="297" border="1" style="border-collapse:collapse">
	...
	if($today2=='Sun')
		...
		$thu='Chủ Nhật';*/
          ...
          upload($tentaptin, $tieude, $mota, $noidung);
        }



        function upload($tentaptin, $tieude, $mota, $noidung)

        {
          ...
          $truyvan = "INSERT INTO du_an (hinhanh,tieude,mota,noidung) VALUES ('" . $tentaptin . "','" . $tieude . "','" . $mota . "','" . $noidung . "')";
