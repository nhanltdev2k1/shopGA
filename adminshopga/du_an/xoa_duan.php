<?php
require('db.php');
$result = mysqli_query($link, "SELECT * FROM du_an WHERE id = '$_GET[id]' ");
...
$chuoi = "DELETE FROM du_an WHERE id = '$_GET[id]' ";

mysqli_query($link, $chuoi);

echo "<form name='frm_dangnhap'>

			        <input type'hidden' name='chuyentrang' value='quan_tri.php?p=danhsach_duan' />
