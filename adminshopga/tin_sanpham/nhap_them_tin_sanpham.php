	...
	if($today2=='Sun')
		$thu='Chủ Nhật';*/
         ...
         // $mota_en = str_replace("'", "", $_POST['mota_en']);
          ...
          upload($noidung, $tentaptin, $tenhinhndab, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $tukhoa, $linkurl);
        }

        function upload($noidung, $tentaptin, $tenhinhndab, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $tukhoa, $linkurl)
        {
          //$ketnoi_maychu = ketnoi_MC();
          //chon_CSDL($ketnoi_maychu);
		  include("db.php");

          $truyvan = "INSERT INTO tin_sanpham (`hinhanh`, `hinhndab`, `noidung` ,`trangchu`,`mota`, `tieude`, `tieude_en`, `tukhoa`, `linkurl`,`thuocloai`) VALUES ('$tentaptin', '$tenhinhndab', '$noidung', '$trangchu', '$mota', '$tieude', '$tieude_en', '$tukhoa', '$linkurl', '$thuocloai')";
