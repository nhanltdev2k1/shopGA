...
<table width="780" height="297" border="1"  style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td width="344" height="22"><div align="center"><strong>Thông Báo </strong></div></td>

    <td width="420"><div align="center"><strong>Hướng Dẫn </strong></div></td>
  ...
  if(isset($_POST['luu']))

   {
	...
	$noidung=$_POST['noidung'];
     ...
     upload($user,$quantri,$noidung);

   }

   

function upload($user,$quantri,$noidung)

 {
   ...
   $user=$_POST['id'];
   $truyvan = "INSERT INTO traloi(user,quantri,noidung) VALUES ('$user','$quantri','$noidung')";
  ...
  <tr>
    ...
    <td height="80" colspan="2" align="center" valign="top"><form action="" method="post" enctype="multipart/form-data" name="tt_mh" id="tt_mh"  onsubmit="return checkInput();">
      ...
      <td></td>
	   ...
	   $sql=mysql_query("select * from binhchon where id=".$_GET['id']."");
	   $row=mysql_fetch_array($sql);	   	   
	   ?>
       <label>Họ tên: <?php echo $row['hoten'];?></label><br />
       <label>Họ tên: <?php echo $row['email'];?></label><br />
       <label>Nội dung: <?php echo $row['mota'];?></label><br />
       </td>
      </tr>
      <tr>
       <td><label>Người trả lời:</label></td>
       <td>
       ...
       <tr>
          ...
          <td><div align="left"><strong>Nội dung</strong></div></td>
