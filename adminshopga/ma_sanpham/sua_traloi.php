...
<title>Sửa Danh Mục Trả Lời</title>
...
<table width="780" height="145" border="1"  style="border-collapse:collapse">
  ...
  <tr>
	...
	if($_GET['id']!=''){
	 $mySql=mysql_query("select * from traloi where id=".$_GET['id']."");
  ...
  <tr>
    <td height="66"  colspan="2" align="center" valign="top"><form action="" method="post" enctype="multipart/form-data" name="tt_mh" id="tt_mh"  onsubmit="return checkInput();">
      <table width="780" border="1" bordercolor="black" style="border-collapse:collapse; border-color:#FF0000">
        <tr>
          <td width="233" valign="top"><div align="left"><strong>Người trả lời </strong></div></td>
          <td width="531"><div align="left">
            <label>
            <input type="text" name="hoten" value="<?php echo $suabinhchon['quantri'];?>" />
              </label>
            </div></td>
        </tr>
        <!--
        ...
        <tr>
          ...
          <td><div align="left">
              <label>
              <input name="mota" type="text" id="mota" value="<?php echo $suabinhchon['binhluan'];?>" />
              </label>
          </div></td>
        </tr>
        -->
        ...
        <tr>
          <td height="40" valign="top"><div align="left"><strong>Nội dung</strong></div>          </td>
          <td><div align="left">
              <script type="text/javascript">
										...
										oFCKeditor.Value="<?php echo $suabinhchon['noidung'];?>";
