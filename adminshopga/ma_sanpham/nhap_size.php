...
<title>Nhập Thêm Danh Mục Size</title>
  ...
  if(isset($_POST['luu']))
   {
	...
	//$thuocloai_en = $_POST['thuocloai_en'];
     upload($pro_id,$size,$gia);
   }
   
function upload($pro_id,$size,$gia)
 {
   $ketnoi_maychu = ketnoi_MC();
	chon_CSDL($ketnoi_maychu);
   $truyvan = " INSERT INTO size (pro_id,size,gia) VALUES (".$pro_id.",'".$size."',".$gia.")";
...
function xoataptin($tentaptin)
 {
   $ketnoi_maychu = ketnoi_MC();
	...
	$truyvan = "DELETE FROM tintuc WHERE id = $masotaptin ";
	$ketqua_truyvan = truyvan($truyvan,$ketnoi_maychu);
 }
?></td>
    <td valign="top"><p><br />
  ...
  <tr>
    <td height="66"  colspan="2" align="center" valign="top"><form action="" method="post" enctype="multipart/form-data" name="tt_mh" id="tt_mh"  onsubmit="return checkInput();">
      <table width="780" border="1" bordercolor="black" style="border-collapse:collapse; border-color:#FF0000">
          ...
          <td width="531"><div align="left">
            ...
            <select name="pro_id">
              <?php
			   ...
			   ?>
               <option value="<?php echo $pro_id['id'];?>"><?php echo $pro_id['tieude'];?></option>
               <?php
			   }			  
			  ?>
              </select>
        ...
        <tr>
          <td valign="top"><div align="left"><strong>Size</strong></div></td>
          <td><div align="left">
            <label>
              <input name="size" type="text" id="tieude2" size="60"  maxlength="70"/>
            </label>
          </div></td>
        </tr>
        <tr>
          <td valign="top"><div align="left"><strong>Giá</strong></div></td>
          <td><div align="left">
            <label>
              <input name="gia" type="text" id="tieude2" size="60"  maxlength="70"/>
            </label>
          </div></td>
        </tr>
