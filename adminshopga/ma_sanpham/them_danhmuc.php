  ...
  if(isset($_POST['luu']))

   {
	...
	if($today2=='Sun')
     ...
     upload($thuocloai,$tieude);

   }

   

function upload($thuocloai,$tieude)

 {
   ...
   $truyvan = "INSERT INTO danhmuc(thuocloai,tieude) VALUES ('$thuocloai','$tieude')";
...
<?php
  ...
  <tr>
    ...
    <td height="80" colspan="2" align="center" valign="top"><form action="" method="post" enctype="multipart/form-data" name="tt_mh" id="tt_mh"  onsubmit="return checkInput();">
      ...
      <tr>
      <td><div align="left"><strong>Loại sản phẩm </strong> </div></td>
