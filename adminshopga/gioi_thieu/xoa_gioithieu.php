...
$result = mysqli_query($link,"SELECT * FROM gioi_thieu WHERE id = '$_GET[id]' ");
...
$chuoi = "DELETE FROM gioi_thieu WHERE id = '$_GET[id]' ";

mysqli_query($link,$chuoi);

echo "<form name='frm_dangnhap'>

			        <input type'hidden' name='chuyentrang' value='quan_tri.php?p=danhsach_gioithieu' />
